...
* *Administra gráficamente la base de datos.*
...
* *`!` invierte: `!.env` lo incluye aunque `.env.*` esté ignorado.*
...
*La diferencia es solo semántica. `until <fail>` y `while ! <command>` son funcionalmente equivalentes.*
